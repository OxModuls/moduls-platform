      ...
      <div className="w-full lg:max-w-[84rem]">
        ...
        <div className="hidden w-full items-center justify-between gap-6 rounded-2xl border px-6 py-8 shadow-lg md:flex">
          ...
          <button
            ...
            className="bg-button-gradient mt-3 flex w-fit shrink-0 cursor-pointer justify-center rounded-xl px-3 py-2 text-lg font-bold transition-all duration-500 hover:-translate-y-1"
          >
            <div className="flex items-center justify-between gap-1">
              <span className="">Launch Agent</span>
            </div>
        ...
        <div className="mt-8 hidden w-full items-start gap-4 rounded-2xl border px-8 py-8 shadow-lg md:flex">
          ...
          <div className="flex grow items-center justify-between gap-6">
            ...
            <button
              ...
              className="bg-button-gradient mt-3 inline-block shrink-0 rounded-xl px-3 py-2 text-lg font-bold transition-all duration-500 hover:scale-105"
            >
              Get Started Now
            </button>
          </div>
